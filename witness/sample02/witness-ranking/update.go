...
func makePreviousRanks(list []Witness) map[string]int {
...
func RunUpdate(cfg Config) error {
	...
	for _, span := range spans() {
		...
		if err != nil {
			...
			previousRanks = makePreviousRanks(previous)
		...
		if err := WriteWitnessCompareCSV(out, compared, previousRanks); err != nil {
